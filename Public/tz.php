...
<table>
  ...
  <tr>
    <td>服务器域名/IP地址</td>
    <td colspan="3">yahei - www.yahei.net(110.34.192.14)&nbsp;&nbsp;你的IP地址是：113.68.208.214</td>
  </tr>
  <tr>
    <td>服务器标识</td>
    <td colspan="3">Linux relaxnetwork1 2.6.18-164.el5 #1 SMP Thu Sep 3 03:33:56 EDT 2009 i686</td>
  </tr>
  <tr>
    <td width="13%">服务器操作系统</td>
    <td width="37%">Linux &nbsp;内核版本：2.6.18-164.el5</td>
    <td width="13%">服务器解译引擎</td>
    <td width="37%">Apache/2</td>
  </tr>
  <tr>
    <td>服务器语言</td>
  ...
  <tr>
	  ...
	  <td>relaxnetwork1</td>
	  <td>绝对路径</td>
	  <td>/home/yahei/domains/yahei.net/public_html</td>
	</tr>
  <tr>
	  <td>管理员邮箱</td>
	  <td>webmaster@yahei.net</td>
		<td>探针路径</td>
		<td>/home/yahei/domains/yahei.net/public_html/tz/tz.php</td>
	</tr>	
</table>
...
date&nbsp;&nbsp;libxml&nbsp;&nbsp;openssl&nbsp;&nbsp;pcre&nbsp;&nbsp;zlib&nbsp;&nbsp;bcmath&nbsp;&nbsp;calendar&nbsp;&nbsp;ctype&nbsp;&nbsp;curl&nbsp;&nbsp;dom&nbsp;&nbsp;filter&nbsp;&nbsp;ftp&nbsp;&nbsp;gd&nbsp;&nbsp;<br />gettext&nbsp;&nbsp;hash&nbsp;&nbsp;iconv&nbsp;&nbsp;json&nbsp;&nbsp;mbstring&nbsp;&nbsp;mcrypt&nbsp;&nbsp;mhash&nbsp;&nbsp;mysql&nbsp;&nbsp;SimpleXML&nbsp;&nbsp;SPL&nbsp;&nbsp;PDO&nbsp;&nbsp;pdo_mysql&nbsp;&nbsp;pdo_sqlite&nbsp;&nbsp;<br />posix&nbsp;&nbsp;Reflection&nbsp;&nbsp;session&nbsp;&nbsp;mysqli&nbsp;&nbsp;sockets&nbsp;&nbsp;SQLite&nbsp;&nbsp;standard&nbsp;&nbsp;tokenizer&nbsp;&nbsp;xml&nbsp;&nbsp;xmlreader&nbsp;&nbsp;xmlwriter&nbsp;&nbsp;zip&nbsp;&nbsp;apache2handler&nbsp;&nbsp;<br />ionCube Loader&nbsp;&nbsp;Zend Optimizer&nbsp;&nbsp;</span>
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td width="18%">
		    <a href='/tz/tz.php?act=phpinfo' target='_blank'>PHPINFO</a>    </td>
    <td width="32%">PHP版本（php_version）：</td>
    <td width="18%">5.2.17</td>
  </tr>
  <tr>
    <td>PHP运行方式：</td>
  ...
  <tr>
   ...
   <tr>
	...
	<tr>
		...
		<td colspan="3"><a href='/tz/tz.php?act=Function' target='_blank' class='static'>请点这里查看详细！</a></td>		
	</tr>
	<tr>
		<td>被禁用的函数（disable_functions）：</td>
		<td colspan="3" class="word">
passthru&nbsp;&nbsp;exec&nbsp;&nbsp;system&nbsp;&nbsp;chroot&nbsp;&nbsp;scandir&nbsp;&nbsp;<br />chgrp&nbsp;&nbsp;chown&nbsp;&nbsp;shell_exec&nbsp;&nbsp;proc_open&nbsp;&nbsp;proc_get_status&nbsp;&nbsp;<br />ini_alter&nbsp;&nbsp;ini_alter&nbsp;&nbsp;ini_restore&nbsp;&nbsp;dl&nbsp;&nbsp;pfsockopen&nbsp;&nbsp;<br />openlog&nbsp;&nbsp;syslog&nbsp;&nbsp;r&nbsp;&nbsp;		</td>
	</tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td width="18%">2.2.0</td>
    <td width="32%">
Zend Optimizer	</td>
    <td width="18%">3.3.3</td>
  </tr>
  <tr>
    <td>eAccelerator</td>
    <td><font color=red>×</font></td>
...
<table>
  ...
  <tr>
    <td>SQLite 数据库：</td>
    <td><font color="green">√</font>&nbsp; 版本： 2.8.17</td>
    <td>Hyperwave 数据库：</td>
    <td><font color="red">×</font></td>
  </tr>
  <tr>
...
<form action="/tz/tz.php#bottom" method="post">
<!--服务器性能检测-->
<table>
  ...
  <tr>
	...
	<table>
		<tr>
			...
			<td class="w_foot">Processed in 1.0023 seconds. 0.44MB memory usage.</td>
