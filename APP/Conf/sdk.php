...
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://liehu.testym.com/index.php?g=User&m=Sdk&a=callback&type=');

return array(
	//腾讯QQ登录配置
	'THINK_SDK_QQ' => array(
		'APP_KEY'    => '101182463', //应用注册成功后分配的 APP ID
		'APP_SECRET' => 'e75a4f70c64d83d9e39771983f14d300', //应用注册成功后分配的KEY
