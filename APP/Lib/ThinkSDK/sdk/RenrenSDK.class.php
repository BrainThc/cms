...
class RenrenSDK extends ThinkOauth{
	 ...
	 * @var string
	 */
	//protected $ApiBase = 'http://api.renren.com/restserver.do'; // v1版本
	protected $ApiBase = 'https://api.renren.com/v2/user/login/get'; //v2版本

	/**
	 * 组装接口调用参数 并调用接口
	 * @param  string $api    微博API
	 * @param  string $param  调用API的额外参数
	 * @param  string $method HTTP请求方法 默认为GET v1是POST，v2是GET
	 * @return json
	 */
