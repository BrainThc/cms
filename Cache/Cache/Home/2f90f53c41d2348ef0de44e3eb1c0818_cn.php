...
<!--载入主体--> 
<!--banner-->
    <div class="inside_banner" style="background: url('__STYLE__/img/c1.png') no-repeat center;height: 400px;">
    </div>
    <a name="case">
    </a>
    ...
    <div class="wrap alzsbox2">
       ...
       <?php $n=0;foreach($Categorys as $key=>$r):if( $r['ismenu']==1 && intval($catid1)==$r["parentid"] ) :++$n; if(0!=0 && $n > 0) break;?><a  class="<?php if(is_child($catid,$r['arrchildid'])) : ?> cur <?php endif;?>" href="<?php echo ($r["url"]); ?>"><?php echo ($r["catname"]); ?></a><?php endif; endforeach;?>
       </div>
       <div class="listBox2">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                <a href="<?php echo ($vo["url"]); ?>">
                  <div class="imgBox2">
                    <img src="<?php echo ($vo["thumb"]); ?>" class="img" alt="<?php echo ($vo["title"]); ?>">
                    <div class="bg"></div>
